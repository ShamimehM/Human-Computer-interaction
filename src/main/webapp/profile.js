document.addEventListener('DOMContentLoaded', function() {
    ...
    const username = localStorage.getItem('username') || 'WonderWoman';
    const birthday = localStorage.getItem('birthday') || null;
    const height = localStorage.getItem('height') || '80';
    const weight = localStorage.getItem('weight') || '10';
    const gender = localStorage.getItem('gender') || 'Non'; 
